...
VVV1_mod = Lorentz(name = 'VVV1_mod',
               spins = [ 3, 3, 3 ],
               structure = '(P(3,3)*Metric(2,1)+P(2,2)*Metric(1,3)-P(1,1)*Metric(3,2))')

### modified by Arka to include beta dependence, using Lee Yang field
VVV1_mod2 = Lorentz(name = 'VVV1_mod2',
               spins = [ 3, 3, 3 ],
               structure = '(Metric(2,1)*(P(3,1) - P(3,2)) + Metric(1,3)*(-P(2,3) - P(2,1)) + Metric(3,2)*(P(1,2)+P(1,3)))')
...
VVVV2_mod = Lorentz(name = 'VVVV2_mod',
                spins = [ 3, 3, 3, 3 ],
                structure = '(Metric(1,4)*Metric(2,3) + Metric(1,3)*Metric(2,4) - 2*Metric(1,2)*Metric(4,3))') ### interchanging 3 and 4 in last term
